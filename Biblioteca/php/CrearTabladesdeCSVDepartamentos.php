<?
	...
	/* if (!mysqli_query($c1,"LOAD DATA LOCAL INFILE '" . $_SERVER['DOCUMENT_ROOT'] . "/Biblioteca/csv/Departamentos.csv" . "'
	...
	$fic = fopen($_SERVER['DOCUMENT_ROOT'] . "/Biblioteca/csv/Departamentos.csv","r");
	$fila = fgetcsv($fic,0,";");
