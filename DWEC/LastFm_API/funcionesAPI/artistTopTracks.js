...
var artistTopTracks = async function(artist, orden, direc){
  try{
    ...
    if(numResults==0){
      ...
      /* Obtención del JSON */
      console.log(`http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&artist=${artist}&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&autocorrect=1&limit=50`)
    ...
    console.error("Error en ARTISTTOPTRACKS");
