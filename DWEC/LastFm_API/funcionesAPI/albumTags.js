  ...
  try {
    ...
    if(numResults==0){
      ...
      /* Obtención del JSON Inicial*/
        console.log(`http://ws.audioscrobbler.com/2.0/?method=album.gettoptags&artist=${artist}&album=${album}&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&autocorrect=1&limit=50`);
        response = await fetch(`http://ws.audioscrobbler.com/2.0/?method=album.gettoptags&artist=${artist}&album=${album}&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&autocorrect=1&limit=50`);
