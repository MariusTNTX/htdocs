...
var chartTopAlbums = async function(general, orden, direc){
  try{
    ...
    if(numResults==0){
      ...
      /* Obtención del JSON */
      console.log("http://ws.audioscrobbler.com/2.0/?method=chart.gettopartists&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&limit=50")
      response = await fetch("http://ws.audioscrobbler.com/2.0/?method=chart.gettopartists&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&limit=50");
      ...
      for(let i=0; i<response.length; i++){
        try{
          ...
          /* Obtener el álbum top del artista */
          console.log(`http://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=${artista}&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&autocorrect=1`)
    ...
    if(numResults < maxResults){
      console.log("numResults < maxResults")
