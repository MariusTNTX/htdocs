...
var chartTopTracks = async function(general, orden, direc){
  try{
    ...
    if(numResults==0){
      ...
      /* Obtención del JSON */
      console.log("http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=5a29d744e8273ab4a877e9b59555b81e&format=json&limit=50")
      ...
      for(let i=0; i<response.length; i++){
        try{
          ...
          /* Verificar undefined */
          if(typeof(response[i])==='undefined' || response[i].album==undefined){
            console.log("ALBUM ELIMINADO");
            response.splice(i,1);
            i--;
            continue;
